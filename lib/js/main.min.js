...
!function(){"use strict";function t(t){var n='<div class="ngn" ng-class="ngNotify.notifyClass"><span ng-if="ngNotify.notifyHtml" class="ngn-message" ng-bind-html="ngNotify.notifyMessage"></span><span ng-if="!ngNotify.notifyHtml" class="ngn-message" ng-bind="ngNotify.notifyMessage"></span><span ng-show="ngNotify.notifyButton" class="ngn-dismiss" ng-click="dismiss()">&times;</span></div>';t.put(s,n)}function n(t){function n(t,n,i){this.scope=t,this.options=i,this.template=o(n)}var i;n.prototype={show:function(t){this.template.fadeIn(m,t)},dismiss:function(){this.template.fadeOut(g,this.destroy.bind(this))},destroy:function(){t.cancel(i),this.options&&this.options.userCallback&&this.options.userCallback(),this.scope&&this.scope.$destroy(),this.template&&this.template.el.remove(),this.scope=null,this.options=null,this.template=null}};var o=function(t){return new o.fn(t)};return o.fn=function(t){this.el=t},o.fn.prototype._fade=function(n,o,e,s){var r=p/e,a=this.el;a.css("opacity",o);var u=function(){o+=n*r,a.css("opacity",o),(h>=o||o>=v)&&(t.cancel(i),h>=o&&a.css("display","none"),s&&s())};i=t(u,p)},o.fn.prototype.fadeIn=function(t,n){this.el.css("display","block"),this._fade(y,h,t,n)},o.fn.prototype.fadeOut=function(t,n){this._fade(d,v,t,n)},n}function i(){this.$get=["$document","$compile","$log","$rootScope","$timeout","$templateCache","NgNotifyFactory",function(t,n,i,o,g,p,y){var d,m,h={theme:"pure",position:"bottom",duration:l,type:"info",sticky:!1,button:!0,html:!1,target:f},v={notifyClass:"",notifyMessage:""},b={pure:r,prime:"ngn-prime",pastel:"ngn-pastel",pitchy:"ngn-pitchy"},N={info:"ngn-info",error:"ngn-error",success:"ngn-success",warn:"ngn-warn",grimace:"ngn-grimace"},k={bottom:"ngn-bottom",top:"ngn-top"},S=function(){var t=o.$new();return t.ngNotify=angular.extend({},v),t.dismiss=function(){F()},t},$=function(t,i,o){var e={},r=S();"object"==typeof i?e=i:e.type=i;var a=j(e),u={isSticky:q(e),duration:M(e),userCallback:o};angular.extend(r.ngNotify,{notifyHtml:I(e),notifyClass:_(e,u.isSticky,a.found),notifyButton:x(e,u.isSticky),notifyMessage:t});var c=n(p.get(s))(r);return a.target.append(c),new y(r,c,u)},w=function(t){var n=t.type||h.type;return(N[n]||N.info)+a},C=function(t){var n=t.theme||h.theme;return(b[n]||b.pure)+a},z=function(t){var n=t.position||h.position;return(k[n]||k.bottom)+a},M=function(t){var n=t.duration||h.duration;return angular.isNumber(n)?n:l},q=function(t){var n=void 0!==t.sticky?t.sticky:h.sticky;return!!n},x=function(t,n){var i=void 0!==t.button?t.button:h.button;return i&&n},H=function(t){return t.target||h.target},I=function(t){if((t.html||h.html)&&!e)return i.debug("ngNotify warning:\nngSanitize couldn't be located.  In order to use the 'html' option, be sure the ngSanitize source is included in your project."),!1;var n=void 0!==t.html?t.html:h.html;return!!n},_=function(t,n,i){var o=w(t)+C(t)+z(t);return o+=n?u+a:r,o+=H(t)!==f&&i?c+a:r},j=function(t){var n=document.querySelector(H(t));return n?{target:angular.element(n),found:!0}:{target:angular.element(document.querySelector(f)),found:!1}},B=function(){d.options.isSticky||(m=g(function(){d.dismiss()},d.options.duration))},F=function(){d&&d.dismiss()},O=function(t){g.cancel(m),t&&(t.scope&&t.destroy(),t=null)};return{config:function(t){t=t||{},angular.extend(h,t)},set:function(t,n,i){t&&(O(d),d=$(t,n,i),d.show(B))},dismiss:function(){F()},addTheme:function(t,n){t&&n&&(b[t]=n)},addType:function(t,n){t&&n&&(N[t]=n)}}}]}var o=angular.module("ngNotify",[]);o.run(["$templateCache",t]),o.factory("NgNotifyFactory",["$interval",n]),o.provider("ngNotify",i);var e=!1,s="templates/ng-notify/ng-notify.html",r="",a=" ",u="ngn-sticky",c="ngn-component",f="body",l=3e3,g=500,p=25,y=1,d=-1,m=200,h=0,v=1;try{angular.module("ngSanitize")&&(angular.module("ngNotify").requires.push("ngSanitize"),e=!0)}catch(b){}}();